<div align="center">
  ...
  <h4>This is a learning project built to explore full-stack development with Java (Android + Spring Boot).</h4>
  <h4>The focus is on understanding system design, API development, and client-server interaction rather than building a production-ready application.</h4>
</div>
