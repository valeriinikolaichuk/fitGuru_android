<div align="center">
  <h3>FitGuru</h3>
  <h4>FitGuru is a fitness trainer-client application for creating, managing, and sharing workout programs between personal trainers and their clients. The application is designed to be as simple and practical as possible, focusing only on creating, tracking, and sharing workout plans.</h4>
